...
public class Car {
	final Point polozeniePoczatkowe = new Point(900, 330);
	...
	final Point wymiary = new Point((int)(130*rozmiarAuta), (int)(300*rozmiarAuta)); //zawsze pierwszy wymiar ma byc mniejszy!!!!
	...
	MyPanel panel;
	Point polozenie;// poprzednie_polozenie;//przez polozenie rozumiem tylko wspolrzedne punktu srodka osi tylnych kol nie uwzgledniam u kierunku
