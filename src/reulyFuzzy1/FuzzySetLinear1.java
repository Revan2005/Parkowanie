...
public class FuzzySetLinear1 {
	...
	//}
	private void sortujWierzcholki(){
	...
	private ArrayList<Punkt2D> sortujPunktyPrzeciec(ArrayList<Punkt2D> punktyPrzeciec){
	...
	private double getValue(Punkt2D p1, Punkt2D p2, double x){
	...
	private Punkt2D getPunktPrzeciecia(Punkt2D[] para1, Punkt2D[] para2){
